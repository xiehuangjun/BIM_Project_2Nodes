...
cur = mysql.cursor()
cur.execute('''CREATE DATABASE BIMP2N;''')

cur.execute('''CREATE TABLE IF NOT EXISTS BIMP2N.Project_Name (
...
cur.execute('''CREATE TABLE IF NOT EXISTS BIMP2N.Project_Information(
